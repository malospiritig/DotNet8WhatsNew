...
public class CreateBenchmark
{
    ...
    {
        HashSet<int> hashSet = Enumerable.Range(0, items).ToHashSet();
    }

    [Benchmark]
    public void CreateImmutableHashSet()
    {
        ImmutableHashSet<int> immutableHashSet = Enumerable.Range(0, items).ToImmutableHashSet();
    }
...
public class LookupBenchmark
{
    ...
    private readonly HashSet<int> hashSet = Enumerable.Range(0, items).ToHashSet();
    private readonly ImmutableHashSet<int> immutableHashSet = Enumerable.Range(0, items).ToImmutableHashSet();
